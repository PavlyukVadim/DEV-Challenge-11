...
class ControlPanel extends Component {
  ...
  toTop() {
    if (window.scrollObj) {
      window.scrollTo(
        window.scrollObj.scrollLeft,
        window.scrollObj.scrollTop - this.scrollStep
      );
    }
  }
  ...
  toLeft() {
    if (window.scrollObj) {
      window.scrollTo(
        window.scrollObj.scrollLeft - this.scrollStep,
        window.scrollObj.scrollTop
      );
    }
  }
